...
function getForcedTeraType(pokemonName) {
	if (startsWith(pokemonName, "Ogerpon-Cornerstone")) {
		...
		return "Stellar";
	} else if (startsWith(pokemonName, "Skeledirge")) {
		return "Grass";
	} else if (startsWith(pokemonName, "Samurott-Hisui")) {
		return "Fire";
	} else if (startsWith(pokemonName, "Tinkaton")) {
		return "Water";
	} else if (startsWith(pokemonName, "Blissey")) {
		return "Fairy";
	} else if (startsWith(pokemonName, "Pincurchin")) {
		return "Dragon";
...
$(".ability").bind("keyup change", function () {
	...
	var TOGGLE_ABILITIES = ['Flash Fire', 'Intimidate', 'Minus', 'Plus', 'Slow Start', 'Unburden', 'Stakeout', 'Teraform Zero', 'Sink or Swim'];
